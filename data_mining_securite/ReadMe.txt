========================================================================
    APPLICATION CONSOLE : Vue d'ensemble du projet data_mining_securite
========================================================================

AppWizard a créé cette application data_mining_securite pour vous.

Ce fichier contient un résumé du contenu de chacun des fichiers qui constituent votre application data_mining_securite.


data_mining_securite.vcxproj
...
data_mining_securite.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Ces fichiers sont utilisés pour générer un fichier d'en-tête précompilé (PCH) data_mining_securite.pch et un fichier de type précompilé nommé StdAfx.obj.
